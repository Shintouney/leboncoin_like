class Account::OfferController < AccountController
  ...
  def index
    ...
    def offer_params_update
      param = params.require(:offer).permit(:title, :price, :description, :category_id, :cover_picture, :location)
      param[:category_id] = @offer_form.category_id
      param
    end

    def offer_params
      params.require(:offer).permit(:title, :price, :description, :category_id, :cover_picture, :location)
    end
